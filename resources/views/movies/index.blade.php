    ...
    <div class="container mx-auto" x-data="{
        ...
        <div class="mb-12">
            <div class="relative group max-w-md mx-auto md:mx-0">
                ...
                <input type="text" x-model="searchTerm" placeholder="Film ismine göre filtrele..."
                ...
                @foreach ($movies as $movie)
                    <div x-data="{ modalOpen: false }"
                        ...
                        <div @click="modalOpen = true"
                            class="group cursor-pointer relative bg-slate-900 rounded-3xl overflow-hidden border border-slate-800 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/10">
                            ...
                            <div x-show="modalOpen"
                                ...
                                <div @click.away="modalOpen = false"
                                    ...
                                    <button @click="modalOpen = false"
                                        class="absolute top-6 right-6 z-20 bg-slate-800/50 hover:bg-slate-800 text-white w-10 h-10 rounded-full flex items-center justify-center transition-colors"><i
                                    ...
                                    <div class="flex flex-col md:flex-row">
                                        ...
                                        <div class="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center">
                                            <h2 class="text-4xl font-black text-white mb-1 leading-tight">
                                                {{ $movie->title }}</h2>

                                            <p
                                                class="text-indigo-400 text-sm font-bold tracking-widest uppercase mb-5 flex items-center gap-2 drop-shadow-md">
                                            ...
                                            <div class="flex items-center gap-4 mb-8 flex-wrap">
                                                ...
                                                <div class="flex items-center gap-1.5 text-yellow-400"><i
                                                        class="fas fa-star text-base"></i><span
                                                        class="text-lg font-black">{{ number_format($movie->rating ?? 0, 1) }}</span>
                                                </div>
                                                @if ($movie->runtime)
                                                    <div
                                                        class="flex items-center gap-1.5 text-slate-400 text-xs font-bold bg-slate-800 px-2 py-1 rounded-lg">
                                            ...
                                            <h3
                                                ...
                                                Özet</h3>
                                            <p
                                                class="text-slate-300 leading-relaxed text-base italic max-h-40 overflow-y-auto custom-scrollbar pr-2">
                                            ...
                                            <div class="mt-10 pt-8 border-t border-slate-800 flex flex-wrap gap-4">
                                                ...
                                                <form action="{{ route('movies.destroy', $movie) }}" method="POST"
                                                    ...
                                                    @csrf @method('DELETE')
                                                    <button
                                                        class="bg-slate-800 hover:bg-red-600/20 hover:text-red-500 text-slate-400 px-6 py-3 rounded-2xl text-sm font-black transition-all"><i
                                                            class="fas fa-trash-alt mr-2"></i> Sil</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
