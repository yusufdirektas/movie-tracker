                            ...
                            <div @click.away="modalOpen = false" class="bg-slate-900 border border-slate-800 w-full max-w-3xl rounded-[2.5rem] overflow-hidden shadow-2xl relative">
                                ...
                                <div class="flex flex-col md:flex-row">
                                    <div class="w-full md:w-2/5 aspect-[2/3] md:aspect-auto">
                                        @if(isset($rec['poster_path']) && $rec['poster_path'])
                                            <img src="https://image.tmdb.org/t/p/w500{{ $rec['poster_path'] }}" class="w-full h-full object-cover">
                                        @else
                                    ...
                                    <div class="w-full md:w-3/5 p-6 md:p-10 flex flex-col justify-center">
                                        <h2 class="text-2xl md:text-3xl font-black text-white mb-4 leading-tight">{{ $rec['title'] }}</h2>

                                        <div class="flex items-center gap-4 mb-6 flex-wrap">
                                            <span class="bg-indigo-500/10 text-indigo-400 px-3 py-1 rounded-lg font-bold text-xs uppercase border border-indigo-500/20">
                                            ...
                                            <div class="flex items-center gap-1.5 text-yellow-400">
                                                ...
                                                <span class="text-lg font-black">{{ number_format($rec['vote_average'] ?? 0, 1) }}</span>
                                            </div>
                                        </div>
